...
namespace K8SASPNETCOREDemo005.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<string>> Get()
        {
            try
            {
                ...
                return new string[] { "K8SASPNETCOREDemo005--测试服务" + DateTime.Now.ToString("yyyy年MM月dd日 HH:mm:ss"), "所在服务器：" + Environment.MachineName + " OS:" + Environment.OSVersion.VersionString };
            }
            catch (Exception exc)
            {
