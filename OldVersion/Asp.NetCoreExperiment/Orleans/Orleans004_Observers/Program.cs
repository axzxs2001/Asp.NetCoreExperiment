...
namespace Orleans004_Observers
{
    ...
    interface IMyObserver : IGrainObserver
    {
    ...
    {
        private GrainObserverManager<IMyObserver> _subsManager;

        public override async Task OnActivateAsync()
        {
            // We created the utility at activation time.
            _subsManager = new GrainObserverManager<IMyObserver>();
            await base.OnActivateAsync();
        }

        // Clients call this to subscribe.
        public Task Subscribe(IMyObserver observer)
        {
    ...
    public class GrainObserverManager<T> : IEnumerable<T> where T : IAddressable
    {
        ...
        public bool IsSubscribed(T t)
        {
            return observers.ContainsKey(t);
        }
        /// <summary>
